...
// --------------------------------------------------------------------------------
test('normal flow of event: 2nd reminder', async () => {
  const event = {
    appointment:
      '{' +
      'event_type=REMIND,' +
...
// --------------------------------------------------------------------------------
test('abnormal flow of event: MAX_REMINDERS_REACHED', async () => {
  const event = {
    appointment:
      '{' +
      'event_type=REMIND,' +
...
// --------------------------------------------------------------------------------
test('abnormal flow of event: NO_APPOINTMENT_FOUND', async () => {
  const event = {
    appointment:
      '{' +
      'event_type=REMIND,' +
